              ...
              <FormGroup row>
                ...
                </Col>
                {
                    ...
                    <Col xs="12" md="9">
                      ...
                      <span style={{marginLeft: "20px"}}> <Input type="radio" name="specification" value="Others" /> Size</span>

                      <span style={{marginLeft: "20px"}}> <Input type="radio" name="specification" value="Weight" /> Weight</span>
                    </Col>
                }
              </FormGroup>
