  ...
  if (name == 'productImages') {
    ...
    if (!file.name.match(/.(jpg|jpeg|png|gif)$/i)){
      ...
      setTimeout(() => {
        ...
        if (imgWidth == 1680 && imgHeight == 2240) {
          this.setState({
            imgWidth: imgWidth,
            imgHeight: imgHeight,
    ...
    <React.Fragment>
      <FormGroup row>
        <Col md="12">
          ...
          <Label htmlFor="productImageNote"> <strong>Note : </strong>Image Size : 2240*1680 & Image Formate : jpg/jpeg/png/gif </Label>
        </Col>
      </FormGroup>
      <FormGroup row>
        {this.createImages()}
...
<Modal isOpen={this.state.imageAlert} toggle={this.toggleImageAlert}
  ...
  <ModalBody>
    ...
    <strong> Note : </strong> Image Size : 2240*1680 & Image Formate : jpg/jpeg/png/gif
  </ModalBody>
</Modal>
