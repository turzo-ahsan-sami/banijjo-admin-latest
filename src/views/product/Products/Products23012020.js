...
editSpecificationName () {
  ...
  for (var i = 0; i < this.state.aPSN.length; i++) {
    ...
    if (this.state.aPSN[i].type == 0) {
      this.state.editSpecificationNameArray.push(<div> <strong> {'Color'} : </strong> </div>);
...
specificationBoxFun1 (e) {
  ...
  var array = [...this.state.productSpecificationBoxFun1];

  var index = array.indexOf(e.target.value)

  for (var i = 0; i < this.state.productSpecificationBoxFun1.length; i++) {
    if (this.state.productSpecificationBoxFun1[i].colorId == e.target.value) {
      console.log('................................................' + e.target.value + '..............'+ i);
      array.splice(index, 1);
      this.setState({productSpecificationBoxFun1: array});
      ++spCounter;
    }
  }
  ...
  console.log('productSpecificationBoxFun1 : ', this.state.productSpecificationBoxFun1);
