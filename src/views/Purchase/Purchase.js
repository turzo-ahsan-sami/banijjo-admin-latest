...
class Purchase extends Component {
        ...
        .then((purchaseDelete) => {
          ...
          if (purchaseDelete.success == true) {
            ...
            if (purchaseDelete.status == 403) {
              ...
              ToastsStore.warning(
                "Purchase Info deletion Faild. Please try again !!"
              );
      ...
      fetch(
        ...
        .then((products) => {
          ...
          while (i < this.state.productList.length) {
            ...
            productObject.product_name_code =
              this.state.productList[i].product_name +
              " - " +
              this.state.productList[i].product_sku;
  ...
  handleDeleteButton(keyId) {
    ...
    let ProductSpecificationValuesArray = this.state.ProductSpecificationValuesArray.filter(
      (e, i) => i !== keyId
    );
    this.setState({
      ProductSpecificationValuesArray: ProductSpecificationValuesArray,
    });
      ...
      .then((info) => {
        if (info.success == true) {
          ...
          if (info.status == 403) {
            ...
            ToastsStore.warning(
              "Product Purchase Insertion Faild. Please try again !!"
            );
            console.log(info.success);
          }
        }
  ...
  addClick() {
    ...
    this.state.grandTotalQuantity =
      Number(this.state.grandTotalQuantity) +
      Number(this.state.productQuantity);

    this.state.grandTotalPrice =
      Number(this.state.grandTotalPrice) + Number(this.state.totalPrice);
  ...
  editItem(event) {
    ...
    fetch(
      ...
      .then((purchaseUpdate) => {
        console.log(
          "Response From 'getPurchaseInfoForUpdate' update API : ",
          purchaseUpdate
        );
        ...
        while (i < purchaseUpdate.data[3].length) {
          ...
          purchaseObject.productName =
            purchaseUpdate.data[3][i].product_name +
            " - " +
            purchaseUpdate.data[3][i].product_sku;
      ...
      <>
        <Row>
                            ...
                            {PurchasseValue.isConfirmed == "false" ? (
                              <React.Fragment>
                                <a
                                  ...
                                  data-editid={PurchasseValue.id}
                                >
                                  <i
                                    className="fa fa-edit"
                                    title="Edit Products Details"
                                    aria-hidden="true"
                                    style={{ color: "#009345" }}
                                  ></i>
                                </a>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input
                            ...
                            readOnly
                            value={this.state.currentBillNo}
                          />
                        </Col>
                      </FormGroup>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input
                            ...
                            ref="clear"
                            readOnly
                            value={this.state.grandTotalQuantity}
                          />
                        </Col>
                      </FormGroup>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="9">
                          <Input
                            ...
                            ref="clear"
                            readOnly
                            value={this.state.grandTotalPrice}
                          />
                        </Col>
                      </FormGroup>
                      ...
                      <FormGroup row>
                        ...
                        <Col xs="12" md="1">
                          <select
                            ...
                            disabled={
                              this.state.disabledColor ? "disabled" : ""
                            }
                          >
                            ...
                            {this.state.colorList.length > 0
                              ? this.state.colorList.map(
                                  (colorListValue, key) => (
                                    <option value={colorListValue.id} key={key}>
                                      {colorListValue.name}
                                    </option>
                                  )
                                )
                        ...
                        <Col xs="12" md="2">
                          <Input
                            ...
                            ref="clear"
                            onChange={
                              (this.handleAddChange.bind(this),
                        ...
                        <Col xs="12" md="2">
                          <Input
                            ...
                            value={this.state.productPrice || 0}
                          />
                        </Col>
                        ...
                        <Col xs="12" md="1">
                          <Label htmlFor="add">
                            {" "}
                            <a href="#" onClick={this.addClick.bind(this)}>
                              {" "}
                              <i
                          ...
                          {this.state.productListArray.length != 0
                            ? this.state.productListArray.map((values, key) => (
                                <ListGroupItem
                                  ...
                                  tag="button"
                                  name="productName"
                                  onClick={this.handleSearchText.bind(this)}
                                  data-id={values.id}
                                  data-value={values.product_name_code}
                                  action
                                >
                                  {values.product_name_code}
                                </ListGroupItem>
                              ))
                            : null}
                        </Col>
                        ...
                        <FormGroup row key={key1}>
                          <Col md="4">
                            <Input
                              type="text"
                              readOnly
                              value={purchaseValues.productName}
                            />
                          </Col>
                          ...
                          <Col md="2">
                            <Input
                              type="text"
                              readOnly
                              value={purchaseValues.productQuantity}
                            />
                          </Col>
                          ...
                          <Col md="2">
                            <Input
                              type="text"
                              readOnly
                              value={purchaseValues.productPrice}
                            />
                          </Col>
                          ...
                          <Col md="3">
                            <Input
                              type="text"
                              readOnly
                              value={purchaseValues.totalPrice}
                            />
                          </Col>
                          ...
                          <Col md="1">
                            <Label
                              htmlFor="close"
                              name="close"
                              onClick={this.deletePurchaseItem.bind(this, key1)}
                            >
                              {" "}
                              <a href="#">
                                {" "}
          ...
          >
            ...
            <ModalBody>Are You Sure To Delete This Purchase ?</ModalBody>
            <ModalFooter>
              <Button
                color="success"
                onClick={(e) => {
          ...
          >
            ...
            <ModalBody>Are You Sure To Confirm This Purchase ?</ModalBody>
            <ModalFooter>
              <Button
                color="success"
                onClick={(e) => {
                  this.toggleConfirmModal("Yes");
                }}
              >
                Yes
              </Button>{" "}
          ...
          <Modal
            ...
            toggle={this.toggleLargeEdit}
            className={"modal-lg " + this.props.className}
          >
            <ModalHeader toggle={this.toggleLargeEdit}>
                ...
                <FormGroup row>
                  ...
                  <Col xs="12" md="1">
                    <select
                      ...
                      disabled={this.state.disabledColor ? "disabled" : ""}
                    >
                  ...
                  <Label htmlFor="close" name="close" onClick={this.deletePurchaseItem.bind(this,key1)} > <a href="#"> <i className="fa fa-window-close" style={{paddingTop: '11px'}}></i> </a> </Label>
                    ...
                    <Col md="11">
                      ...
                      >
                        ...
                        {purchaseValues.productName}
                        <br />
                        <strong>Color : </strong>
                        {purchaseValues.colorName}
                        <br />
                        <strong>Size : </strong>
                        {purchaseValues.sizeName}
                        <br />
                        <strong>Quantity : </strong>
                        {purchaseValues.productQuantity}
                        <br />
                        <strong>Unite Price : </strong>
                        {purchaseValues.productPrice} <br />
                        <strong> Total Price : </strong>{" "}
                        {purchaseValues.totalPrice}
                      </ListGroupItem>
                    </Col>
