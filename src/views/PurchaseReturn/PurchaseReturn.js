...
class PurchaseReturn extends Component {
  ...
  componentDidMount() {
    ...
    this.state.returnedBy = localStorage.getItem("employee_id");
    ...
    if (
      ...
      this.setState({
        returnedBy: this.state.vendorId,
      });
    }
    ...
    return (
      <Row>
          ...
          <Card>
            ...
            <CardBody>
              <Table responsive bordered>
                ...
                <tbody>
                  {this.state.purchaseReturnList.map(
                    (purchaseReturnListValue, key) => (
                      <tr>
                            ...
                            {purchaseReturnListValue.isConfirmed == "false" ? (
                              <React.Fragment>
                                <a
                                  ...
                                  data-editid={purchaseReturnListValue.id}
                                >
                                  <i
                                ...
                                <a
                                  ...
                                  id="deleteIds"
                                  ref="dataIds"
                                  data-id={purchaseReturnListValue.id}
                                >
                                  <i
                                    className="fa fa-trash fa-lg"
                                    title="Delete Purchase Return Details"
                                    aria-hidden="true"
                                    style={{ color: "#EB1C22" }}
                                  ></i>
                                </a>{" "}
              ...
              <Card>
                <CardBody>
                  ...
                  >
                    <FormGroup row>
                      <Col md="3">
                        <Label htmlFor="purchaseReturnNo">
                          Purchase Return No
                        </Label>
                      </Col>
                      <Col xs="12" md="9">
                        <Input
                          ...
                          readOnly
                          value={this.state.purchaseReturnNo}
                        />
                      </Col>
                    </FormGroup>
                        ...
                        <Col xs="12" md="9">
                          ...
                          <Input
                            ...
                            onChange={
                              ...
                              this.handlePurchaseByVendor.bind(this))
                            }
                    ...
                    <FormGroup row>
                      <Col xs="12" md="12">
                        {this.state.vendorWiseBillNoArray.length != 0
                          ? this.state.vendorWiseBillNoArray.map(
                              (values, key) => (
                                <ListGroupItem
                                  tag="button"
                                  name="vendorWiseBillNoName"
                                  onClick={this.handleBillNoSearchText.bind(
                                    this
                                  )}
                                  data-id={values.id}
                                  data-value={values.vendorWiseBillNo}
                                  data-date={values.date}
                                  action
                                >
                                  {" "}
                                  {values.vendorWiseBillNo}
                                </ListGroupItem>
                              )
                            )
                          : null}
                    ...
                    <FormGroup row>
                      ...
                      <Col xs="12" md="9">
                        <Input
                          ...
                          onChange={this.handleAddChange.bind(this)}
                          value={this.state.purchaseReturnDate}
                        />
                      </Col>
                    </FormGroup>
                    ...
                    <FormGroup row>
                        ...
                        >
                          ...
                          {this.state.colorList.length > 0
                            ? this.state.colorList.map(
                              (colorListValue, key) => (
                                <option value={colorListValue.id}>
                                  {colorListValue.name}
                                </option>
                              )
                            )
                      ...
                      <Col
                        xs="2"
                        style={{ paddingRight: "3px", paddingLeft: "7px" }}
                      >
                        <Input
                          type="text"
                          id="productQuantity"
                ...
                <FormGroup row>
                  <Col md="11">
                    <ListGroupItem
                      ...
                      disabled
                    >
                      <strong>Name & SKU :</strong> {purchaseValues.productName}
                      <br />
                      <strong>Color : </strong>
        ...
        >
          ...
          <ModalBody>Are You Sure To Delete This Purchase Return ?</ModalBody>
          <ModalFooter>
            <Button
              color="success"
              onClick={(e) => {
        ...
        >
          ...
          <ModalBody>Are You Sure To Confirm This Purchase Return ?</ModalBody>
          <ModalFooter>
            <Button
              color="success"
              onClick={(e) => {
