...
class DefaultLayout extends Component {
  ...
  waiting = () => (
    <div className="animated fadeIn pt-1 text-center">Please wait...</div>
  );
                    ...
                    {routes.map((route, idx) => {
                      ...
                      if (
                        ...
                        (route.name === "Category" ||
                          ...
                          route.name === "Purchase" ||
                          route.name === "ProductSpecificationDetails" ||
                          route.name === "User Profile" ||
                          route.name === "Discount" ||
                          route.name === "Sales Info" ||
                          route.name === "Delivery Status")
                      ) {
                        return route.component ? (
                          <Route
                            key={idx}
